...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='aligned', help='dataset loader to use [aligned | wind]')
        self.parser.add_argument('--wind_stats', type=str, default='', help='path to stats.json for wind dataset normalization (defaults to dataroot/stats.json)')
